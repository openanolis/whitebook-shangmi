...
<div align=center>
<img src="images/M88STAR5-DPDK.png" style="width: 100%; height: 100%">
</div>
...
<div align=center>
<img src="images/M88STAR5-可信度量.png" style="width: 100%; height: 100%">
</div>

### 软件开发工具包

<div align=center>
<img src="images/M88STAR5-sdk.png" style="width: 100%; height: 100%">
</div>
...
```
1.sudo modprobe vfio_pci
2.echo 4096 > /proc/sys/vm/nr_hugepages
3.查询BDF:  lspci -d 1b00:d021
4.sudo /usr/local/bin/dpdk-devbind.py -b vfio-pci  $BDF
```
...
```
sudo ./build/app/dpdk-test-crypto-perf -l 1-2 -a 15:00.1  -- --ptest verify --devtype crypto_tsse --optype aead --aead-algo sm4-gcm --aead-op encrypt --aead-key-sz 16 --aead-iv-sz 12 --aead-aad-sz 16 --total-ops 8 --burst-sz 8 --test-name aead_buff_64 --test-file ./app/test-crypto-perf/data/sm4_gcm.data
```

* 性能测试

```
sudo ./build/app/dpdk-test-crypto-perf -l 1-5 -a 15:00.1  -- --ptest throughput --devtype crypto_tsse --optype aead --aead-algo sm4-gcm --aead-op encrypt --aead-key-sz 16 --aead-iv-sz 12 --aead-aad-sz 16 --total-ops 81920 --buffer-sz 1440 --burst-sz 32
```
